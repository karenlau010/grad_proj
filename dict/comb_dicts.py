...
def clean_dict(filename):
    ...
    fp_may = file(u'./dictionary/药品_可能.dic', 'wb')
    fp_chm = file(u'./dictionary/中草药.dic', 'rb')
    chm_dict = set()
    for chm in fp_chm:
...
if __name__ == "__main__":
    ...
    comb_dicts(base_path, [u'手术分类与代码(ICD-9-CM3).scel.txt_UTF-8', u'国际标准手术编码.scel.txt_UTF-8', u'baidu百科_心脏介入手术.txt', u'a-hospital.com_胸心外科手术.txt', u'a-hospital.com_血管外科手术.txt', u'a-hospital.com_临床常用诊断技术.txt'], u'./dictionary/手术检查.dic')
